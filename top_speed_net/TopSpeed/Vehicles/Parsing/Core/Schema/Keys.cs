        ...
        private static Dictionary<string, HashSet<string>> BuildAllowedKeys()
        {
            return new Dictionary<string, HashSet<string>>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["tire_model"] = Set(
                    ...
                    "downforce_grip_gain",
                    "wear_base_per_km",
                    "wear_slip_rate_per_s",
                    "wear_cornering_slip_weight",
                    "wear_longitudinal_slip_weight",
                    "wear_load_gain",
                    "wear_hot_start_c",
                    "wear_hot_gain_per_c",
                    "wear_cold_start_c",
                    "wear_cold_gain_per_c",
                    "temp_cold_end_c",
                    "temp_optimal_start_c",
                    "temp_optimal_end_c",
                    "temp_overheat_end_c",
                    "grip_very_cold",
                    "grip_cold_end",
                    ...
                    "grip_overheat_end",
                    "grip_cooked",
                    "wear_grip_at_full_wear",
                    "heat_cornering_c_per_s",
                    "heat_acceleration_c_per_s",
                    "heat_braking_c_per_s",
                    "heat_load_c_per_s",
                    "heat_rolling_c_per_s",
                    "cool_airflow_per_mps_per_c_per_s",
                    "exchange_ambient_per_c_per_s",
                    "exchange_road_per_c_per_s",
                    "exchange_wet_road_per_c_per_s",
                    "surface_to_tread_conductance_per_s",
                    "tread_to_carcass_conductance_per_s",
                    "tread_mass_ratio",
                    "carcass_mass_ratio",
