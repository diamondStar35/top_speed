...
{
    public enum VehicleTsvIssueSeverity
    {
        Warning = 0,
        Error = 1
    }

    public readonly struct VehicleTsvIssue
    {
    ...
    public sealed class CustomVehicleMeta
    {
    ...
    public sealed class CustomVehicleSounds
    {
    ...
    public sealed class CustomVehicleTsvData
    {
