...
public:
    ...
    void gotoMultiHostOptions( );
    void gotoMultiHostOptionsNrOfLaps( );
...
private:
    ...
    Boolean                 m_multiAcceptingPlayers;
...
//    DirectX::Sound*         m_soundSingleCustomVehicles;
    ...
    Item                    m_multiHostOptions[2];
    Item                    m_multiHostOptionsNrOfLaps[17];
    ...
    Item                    m_multiJoinVehicle[NVEHICLES+3];
